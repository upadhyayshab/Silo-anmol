...
class LeadSource(str, Enum):
    """Values from https://app-in21.leadsquared.com/Settings/ManageCustomFields"""
...
# Maps internal status values (lowercase) → LeadSquared display values.
# To add/change a mapping: edit the relevant inner dict. No code changes needed.
LSQ_STATUS_MAP: dict[str, dict[str, str]] = {
    "delivery_status": {
    ...
    "order_status": {
        "pending":                  "confirmed",
        "delivery_allotted":        "confirmed",
        "postponed":                "confirmed",
        "attempted":                "confirmed",
        "customer_not_available":   "confirmed",
        "unable_to_contact":        "confirmed",
        "unable_to_locate":         "confirmed",
        "payment_not_ready":        "confirmed",
        "delivered":                "completed",
        "cancelled":                "cancelled",
    },
    # CREATE_ORDER activity uses Active/Inactive instead of confirmed/completed
    "order_status_create": {
        "cancelled": "Inactive",
    },
    "payment_status": {
